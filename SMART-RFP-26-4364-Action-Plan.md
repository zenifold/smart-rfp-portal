# RFP 26-4364 Execution Action Plan
...
|------|-------|----------------|
| **Today (Jan 15)** | Start Execution | Review and accept action plan |
| **Jan 20 (Monday)** | Pre-Conference Prep | Finalize questions, register for Zoom |
| **Jan 23 (Friday)** | **Pre-Proposal Conference** | Attend, ask strategic questions, gather intel |
| **Feb 1 (Sunday)** | Check for Addenda | Review MITN website for any RFP updates |
| **Feb 12 (Thursday)** | Final Review | Complete all paperwork, prepare submission |
| **Feb 13 (Friday)** | **SUBMISSION DEADLINE** | Submit by 3:00 PM ET |

---

## 🎯 YOUR TASKS (Maximilian - Must Do Independently)

### HIGH PRIORITY - Complete by January 20, 2026

#### 1. Register for Pre-Proposal Conference ⚠️ URGENT
- **Task:** Register for January 23rd Zoom conference
- **Where:** Click Zoom link in RFP Section 3.00
- **Deadline:** January 20, 2026
- **Why:** See competitors, plant seeds, gather intel

#### 2. Contact Your Insurance Broker ⚠️ URGENT
- **Task:** Request insurance quotes/certificates meeting SMART requirements
- **Requirements (from RFP Section 5.00 A):**
  - Comprehensive General Liability: $1M occurrence / $2M general aggregate
  - Products and Completed Operations: $2M
  - Automobile Liability: $1M CSL
  - Employer's Liability: $500,000
  - Workers' Compensation: Statutory Limits
  - SMART named as additional insured
  - 30 days advance written notice of cancellation
  - Primary and non-contributory coverage
  - Waiver of subrogation
- **Note:** Certificates not needed for submission, but must be ready if awarded
- **Deadline:** January 20, 2026

#### 3. Locate Financial Documentation
- **Task:** Gather audited financial statements OR tax returns for past 2 years
- **Required:**
  - 2024 financial statements or tax return
  - 2023 financial statements or tax return
- **Note:** These go in separate email after Notice of Intent to Award, not with initial proposal
- **Deadline:** January 20, 2026 (have them ready)

#### 4. Determine Company Legal Structure
- **Task:** Confirm your joint venture legal entity type for Form 3.03
- **Choose one:**
...
#### 5. Confirm DBE Status
- **Task:** Determine if you have or need DBE certification
- **Options:**
  - If certified: Provide DBE certificate number and percentage participation
  - If not certified: Mark 0% on Form 3.12 (already done in documents)
...
- **Each bio should include:**
  ...
  - Specific role in this SMART project
  - 1-2 sentence relevant achievement
...
- **Also replace:**
  ...
  - [To be provided - Joint Venture Structure] → Legal entity details
- **Deadline:** January 25, 2026
...
- **Forms requiring signature:**
  ...
  - Form 3.12: Offeror and Subcontractor Certifications (DBE section)
  - Form 3.12: Offeror and Subcontractor Certifications (Prompt Payment section)
  - Form 3.02: Acknowledgement of Addenda (only if addenda issued)
  - Form 3.03: Offer and Award (Offeror section)
  - Technical Proposal conclusion page
...
- **Options:**
  ...
  - Use Google Docs (upload .md, download as PDF)
  - Use Adobe Acrobat
  - Use online markdown-to-PDF converters
- **Naming convention:**
  - SMART-RFP-26-4364-Technical-Proposal.pdf
  - SMART-RFP-26-4364-Pricing-Proposal.pdf
...
- **Follow-up:** Wait 1 hour, then contact if no receipt acknowledgment
- **Emergency contact:** Erika Blocker (eblocker@smartbus.org, 313-223-2141)
- **Deadline:** February 13, 2026 @ 3:00 PM ET

---

## 📋 MY TASKS (Cline/AI Assistant - Will Complete)
...
#### 2. Company Information Updates (Awaits your completion)
- **Dependency:** You provide company name, address, contact info, EIN, legal entity type
- **I will:** Update all placeholders across all documents consistently
- **Files to update:** All 4 documents
- **Your deadline:** January 25, 2026
- **My turnaround:** Same day

#### 3. Post-Conference Document Updates (Awaits conference attendance)
- **Dependency:** You provide notes from January 23rd conference
- **I will:**
  - Update Technical Proposal if needed based on SMART's answers
  - Adjust Pricing Proposal if scope changes
  - Update any assumptions based on conference intel
- **Your deadline:** Provide notes by January 24, 2026
- **My turnaround:** 1-2 business days

#### 4. Addenda Monitoring (Ongoing)
- **Task:** Monitor for any RFP addenda
- **I will:** Check MITN website weekly and alert you to any changes
- **Action:** Update Form 3.02 if addenda issued
- **Frequency:** Weekly until February 13, 2026

#### 5. Final Polish (Awaits your signature)
- **Dependency:** You complete all signatures, page numbering, PDF conversion
- **I will:** Review final PDFs for formatting consistency, typos, completeness
- **Your deadline:** February 10, 2026
- **My turnaround:** 1 business day
...
- [ ] Register for pre-proposal conference ⚠️
- [ ] Contact insurance broker ⚠️
...
**Monday (Jan 20):**
- [ ] Complete all placeholder replacements
- [ ] Send company information to me for document updates
...
- [ ] Take detailed notes
- [ ] Note competitor attendees
- [ ] Send follow-up thank you email

**Saturday (Jan 24):**
- [ ] Send conference notes to me for document updates
...
**SMART Purchasing:**
- Erika Blocker, Senior Purchasing Agent
- Email: eblocker@smartbus.org
- Phone: 313-223-2141

**SMART Civil Rights (DBE/EEO):**
- Candice Fowler, Civil Rights and External Drug and Alcohol Compliance Manager
- Email: cfowler@smartbus.org
- Phone: 313-223-2167

**Submission:**
- Email: bids@smartbus.org
- Website: www.bidnetdirect.com (MITN)
...
1. What task did I complete today toward the proposal?
2. What task is blocking me? What help do I need?
3. What's my #1 priority for tomorrow?

**Weekly (every Monday):**
1. Review this action plan
2. Update completion status
3. Identify any at-risk items
4. Adjust priorities if needed

---

## 🚀 REMINDER: SUCCESS METRICS
...
**Good luck, Maximilian! Let's win this one! 🚀**
